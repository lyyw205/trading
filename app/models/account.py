...
class TradingAccount(TimestampMixin, Base):
    ...
    pending_earnings_usdt: Mapped[float] = mapped_column(Numeric, nullable=False, server_default="0")
    ...
    paper_initial_balance: Mapped[float] = mapped_column(Numeric, nullable=False, server_default="0")
